				...
				<form:form action="/schedule/${id}" method="PUT">
				    <fieldset>
                        ...
                        <div class="mb-3">
                            ...
                            <input list="serviceDetails" value="${currServiceDetails}" class="col-sm-6 custom-select custom-select-sm form-control" name="service" placeholder="Select Service">
                        ...
                        <div class="mb-3">
                            ...
                            <input list="busDetails" value="${currBusDetails}" class="col-sm-6 custom-select custom-select-sm form-control" name="bus" placeholder="Select bus">
                       ...
                       <!--  
                        ...
                        <div class="mb-3">
                            ...
                            <input list="weeks" value="${currWeekDay}" class="col-sm-6 custom-select custom-select-sm form-control" name="week" placeholder="Select week">
                            <datalist id="weeks">
                        ...
                        <div class="grid-row">
                            <div class="mb-3 grid-col">
                                ...
                                <input type="time" class="form-control" id="departureTime" name="depTime" value="${currDep}">
                            </div>    
                        
                            <div class="mb-3 grid-col">
                                <label for="tripDuration" class="form-label">Duration</label>
                                <input type="time" class="form-control" id="tripDuration" name="tripDuration" value="${currDuration}">
                            </div>          
                        </div>
