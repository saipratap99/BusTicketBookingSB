				...
				<fieldset>
					<div>
					  ...
					  <div class="mb-3">
					  	...
					  	<input list="currLocation" value="" class="col-sm-6 custom-select custom-select-sm form-control" name="currLocation" placeholder="Select location">
						<datalist id="currLocation">
